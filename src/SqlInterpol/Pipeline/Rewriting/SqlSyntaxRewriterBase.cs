...
/// <summary>
/// An abstract base class that centralizes segment iteration, literal modification, and clause hunting
...
{
    public virtual bool IsApplicable(ISqlPipelineState state) => true;
