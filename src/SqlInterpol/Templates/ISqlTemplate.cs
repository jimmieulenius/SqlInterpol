...
/// <summary>
/// Represents a high-performance, pre-compiled SQL template that bypasses the standard AST 
/// compilation pipeline to deliver raw SQL string generation and O(1) parameter binding.
/// </summary>
