...
internal static class SqlCrudTemplateCache
{
    ...
    /// <summary>
    /// Intelligently unwraps collections/arrays to extract their underlying scalar element type.
    /// Protects the metadata caching engine from C# generic overload resolution variations.
    /// </summary>
