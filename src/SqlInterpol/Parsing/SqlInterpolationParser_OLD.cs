...
//                 return new SqlSegment(SqlSegmentType.Reference, entityAlias, SqlRenderMode.AliasOnly);
//             }
...
//                 if (context.ParserState.ActiveEntityTarget == null)
//                 {
//                     try
//                     {
...
//                         var builderProp = context.GetType().GetProperty("Builder", flags);
//                         if (builderProp != null) source = builderProp.GetValue(context) ?? context;

//                         var entitiesMember = source.GetType().GetProperty("Entities", flags)?.GetValue(source)
//                                           ?? source.GetType().GetField("_entities", flags)?.GetValue(source);

//                         if (entitiesMember is IEnumerable entities)
//                         {
//                             foreach (var item in entities)
//                             {
//                                 if (item is ISqlEntityBase e && string.Equals(e.Reference?.Alias, stringAlias, StringComparison.OrdinalIgnoreCase))
//                                 {
//                                     context.ParserState.ActiveEntityTarget = e;
//                                     break;
//                                 }
//                             }
//                         }
//                     }
//                     catch { /* Safe ignore if reflection misses */ }
//                 }
//             }
...
//         // 3.5 Check for Subqueries (ISqlQuery)
//         if (value is ISqlQuery query && value is ISqlEntityBase entityQuery)
//         {
//             string? currentKeyword = context.ParserState.CurrentKeyword?.Value;

//             // RECOVERY: Inner queries clobber the shared keyword state. Restore the outer context from the paren stack!
//             var stack = GetKeywordStack(context.ParserState);
//             if (stack.Count > 0)
//             {
//                 var peeked = stack.Peek()?.Value;
//                 if (peeked != null && (
//                     string.Equals(peeked, SqlKeyword.Update.Value, StringComparison.OrdinalIgnoreCase) ||
//                     string.Equals(peeked, SqlKeyword.Insert.Value, StringComparison.OrdinalIgnoreCase) ||
//                     string.Equals(peeked, SqlKeyword.With.Value, StringComparison.OrdinalIgnoreCase)))
//                 {
//                     currentKeyword = peeked;
//                 }
//             }

//             if (string.Equals(currentKeyword, SqlKeyword.With, StringComparison.OrdinalIgnoreCase))
//             {
//                 context.ParserState.EntityRoles[entityQuery] = SqlEntityRole.Cte;
//                 context.ParserState.CurrentKeyword = null;
//                 return new SqlSegment(SqlSegmentType.Reference, entityQuery, SqlRenderMode.BaseName);
//             }
...
//                 isAlias)
//             {
//                 context.ParserState.ActiveEntityTarget = entityQuery;
//             }

//             if (!isAlias)
//             {
//                 context.ParserState.LastAliasableTarget = entityQuery;
//             }
//             else
//             {
//                 if (entityQuery.Reference is ISqlReference entRef && entRef.Alias == null)
//                 {
//                     entRef.Alias = entRef.FallbackAlias;
//                 }
//             }

//             return new SqlSegment(SqlSegmentType.Reference, entityQuery, isAlias ? SqlRenderMode.AliasOnly : null);
//         }

//         // 4. Check for Standard Tables/CTEs (Entities in FROM/UPDATE/INSERT clauses)
//         if (value is ISqlEntityBase entity)
//         {
//             string? currentKeyword = context.ParserState.CurrentKeyword?.Value;

//             // RECOVERY: Ensure standard entities survive inner query clobbering too!
//             var stack = GetKeywordStack(context.ParserState);
//             if (stack.Count > 0)
//             {
//                 var peeked = stack.Peek()?.Value;
...
//         if (endsWithAs && tag == null)
//         {
//             if (context.ParserState.CurrentKeyword == SqlKeyword.Delete)
//                 tag = SqlSegmentTag.DeleteAsKeyword;
//             else if (context.ParserState.CurrentKeyword == SqlKeyword.Update)
//                 tag = SqlSegmentTag.UpdateAsKeyword;
//             else
//                 tag = SqlSegmentTag.AsKeyword;
//         }
...
//                 current = context.ParserState.ExpectsAliasOnly ? current[ws..] : current;
//             }
//         }
