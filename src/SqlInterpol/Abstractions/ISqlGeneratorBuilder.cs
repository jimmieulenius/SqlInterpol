...
/// <summary>
/// The internal engine interface used by both the runtime parser and the AOT Source Generator 
...
public interface ISqlGeneratorBuilder
{
    ...
    /// used to synchronize the runtime AST tracker during JIT fallback scenarios.</param>
