...
//         SqlFeature.DeleteAs, // Transpiled via RenderDeleteAs
//         SqlFeature.UpdateAs  // Transpiled via RewriteSegments
//     };
...
//         // --- COMPILER TRANSPILATION FOR EXPLICITLY ALIASED UPDATE AS ---
//         int upAsIdx = -1;
//         for (int k = 0; k < rewritten.Count; k++)
//         {
//             if (rewritten[k].Type == SqlSegmentType.Raw && rewritten[k].Value is SqlUpdateAsFragment)
//             {
//                 upAsIdx = k; 
//                 break;
//             }
...
//             int setFragIdx = -1;
//             for (int k = upAsIdx + 1; k < rewritten.Count; k++)
//             {
//                 if (rewritten[k].Value is SqlSetFragment) { setFragIdx = k; break; }
//             }

//             int whereKeywordIdx = -1;
//             for (int k = upAsIdx + 1; k < rewritten.Count; k++)
//             {
//                 if (rewritten[k].Tag == SqlSegmentTag.WhereKeyword) { whereKeywordIdx = k; break; }
//             }
...
//     {
//         string targetSql = delete.Target.ToSql(context);

//         // SQL Server requires the target of a multi-table delete to be just the alias (or base name if unaliased).
...
//                         ? e.ToSql(context, SqlRenderMode.AliasOnly)
...
//     /// <summary>
//     /// Transpiles the explicitly aliased DELETE statement into SQL Server's required format.
//     /// Example: DELETE [o] FROM [dbo].[Orders]
//     /// </summary>
...
//         return $"DELETE {alias} FROM {baseName}";
//     }
// }
