...
public class SqlNestedQueryFragment : ISqlQueryFragment, ISqlEntityBase, ISqlSegmentContainer
{
    ...
    /// </summary>
    /// <param name="segments">The preprocessed inner segments.</param>
    /// <param name="reference">The optional reference/alias bound to this subquery.</param>
    ...
    /// <inheritdoc />
    public ISqlFragment Column(string name) => new SqlRawColumnReference(Reference, name);
