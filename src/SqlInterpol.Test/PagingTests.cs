...
{
    [Theory]
    [MemberData(nameof(WithImplicitLimitOffsetData))]
    public void Paging_WithImplicitLimitOffset_RendersCorrectly(SqlTestCase testCase)
    {
        // Arrange
    ...
    public static TheoryData<SqlTestCase> WithImplicitLimitOffsetData =>
    [
