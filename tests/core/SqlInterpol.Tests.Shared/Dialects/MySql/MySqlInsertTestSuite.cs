...
public partial class MySqlInsertTestSuite : IInsertTestSuite
{
    ...
    public static TheoryData<SqlTestCase> ReturningSingleData => [new SqlTestCase(
        ...
        expectedExceptionMessage: "The SQL dialect 'MySql' does not support the operation or fragment type: 'RETURNING'."
    )];
